{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyMvWhRZkkgoXAxnHZASLNgQ",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/JesseHouse/Turbulence128-on-Phone/blob/main/T256-on-Phone.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "Vwn_3Ca-3w0K",
        "outputId": "87d86126-a40e-4be6-c69f-25ec4c056267"
      },
    ...
    },
    {
      ...
      "source": [
        ...
        "dealias = dealias.float()\n",
        "\n",
        "np.random.seed(42)\n",
        "u_real = torch.randn(N, N, N)\n",
        "v_real = torch.randn(N, N, N)\n",
        "w_real = torch.randn(N, N, N)\n",
        ...
        "    step()\n",
        "    if frame % 30 == 0:\n",
        "        speed = (torch.fft.irfftn(u,s=(N,N,N))**2 + torch.fft.irfftn(v,s=(N,N,N))**2 + torch.fft.irfftn(w,s=(N,N,N))**2).sqrt()[N//2].cpu()\n",
        "        if img is None:\n",
      ...
      "metadata": {
        ...
        "id": "JVraci6YE-EU",
        "outputId": "6b0a18e8-4821-4b31-9339-f6e74f51670c"
      },
      "execution_count": null,
      "outputs": [
        {
